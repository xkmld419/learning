...
int PublicConndb::init(ABMException &oExp)
{
  ...
  try
  {
	...
	sql2.clear();
	sql2="INSERT INTO OPERATION(OPT_ID,FOREIGN_ID,CAPABILITY_CODE,SERV_ID,REC_TYPE,RBK_OPT_ID,OPT_DATE,SP_ID,SP_NAME,SERVICE_PLATFORM_ID,ORDER_INFO,ORDER_ID,ORDER_DESC,ORDER_STATE,PAY_TYPE,AMOUNT,STATE_DATE) values(:p1,:p2,:p3,:p4,'1',:p5,sysdate,:p6,:p7,:p8,:p9,:p10,:p11,:p12,:p13,:p14,SYSDATE)";
