...
void packChargeR(DccMsgParser *poDcc)
{
    ...
    iVar = 20110601;
    poDcc->setAvpValue("Service-Information.Micropayment-Info[0].Billing-Cycle-ID", iVar);
...
int main(int argc,char* argv[])
{
    ...
    sVar.assign("RechargeBillQuery.Micropayment@001.ChinaTelecom.com");
