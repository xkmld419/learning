...
//@@ 310050507  获取参数失败      B_PARAM_DEFINE表中没有配置(LOADPARAMINFO, PARAM_MSERVACCT_INFO_NUM)的大小
//@@ 310050508  申请内存失败      请调大B_PARAM_DEFINE表中(LOADPARAMINFO, PARAM_MSERVACCT_INFO_NUM)的大小
