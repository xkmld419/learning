...
*/
int main4GuardMain(int argc, char ** argv)
{
    char opt;
...
void InitProcInfoQry (SQLITEQuery &qry)
{
    qry.setSQL (" select "
            " a.billflow_id billflow_id, "
            " b.app_id app_id, "
            ...
            " nvl(a.vp_id,-1) vp_id, "
            " d.name flow_name "
            " from wf_application b, wf_billflow d, "
            " wf_process a LEFT OUTER JOIN wf_process_mq c on a.process_id = c.process_id "
