...
/*    static void init_ptr (ACE_Malloc_Header **ptr,
                          ...
                          void *base_addr);
*/
    inline static void init_ptr (ACE_Malloc_Header **ptr, ACE_Malloc_Header *init, void *)
    {
      *ptr = init;
    }
...
# endif /* !ACE_MALLOC_PADDING_SIZE */
  ...
  public:
    ...
    inline ~ACE_Name_Node (void)
    {

    }

    inline static void init_ptr(ACE_Name_Node **ptr, ACE_Name_Node *init, void *)
    {
      *ptr = init;
    }
