...
// #if !defined(OS_HPUX) && !defined(DEF_HPUX) && !defined(OS_AIX) && !defined(DEF_AIX)
#if !defined(OS_HPUX) && !defined(DEF_HP) && !defined(OS_AIX) && !defined(DEF_AIX)
  X *operator-> () const;
#endif
