...
ACE_Control_Block::ACE_Malloc_Header::dump (void) const
{
  ...
  ACE_DEBUG ("ACE_Control_Block::ACE_Malloc_Header::dump");
...
{
#if defined (ACE_HAS_DUMP)
  ACE_DEBUG ("ACE_Control_Block::print_alignment_info");
...
{
#if defined (ACE_HAS_DUMP)
  ACE_DEBUG ("ACE_Control_Block::dump");
...
{
#if defined (ACE_HAS_DUMP)
  ACE_DEBUG ("ACE_Control_Block::ACE_Name_Node::dump");
