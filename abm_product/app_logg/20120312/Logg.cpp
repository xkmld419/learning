...
LoggMgr::LoggMgr(int argc, char **argv):g_argc(argc),g_argv(argv){
    LoggMgr::start();
    //reset();
...
void LoggMgr::printUsage()
{
    ...
    cout << "sgwlog" << " "  << "-module  [module] :                       显示所有[指定模块ID]的日志内容"<<endl;
...
int main(int argc, char **argv)
{
   ...
   // g_argv = argv;
     ...
     LoggMgr pMgr(argc, argv);
    
   // LoggMgr * pMgr(argc, argv) = new LoggMgr();
   /*
    if(!pMgr)
    {
