...
public:
	...
	void SetRunMode(int iRunMode);			/* 设置运行模式	*/
	void SetPageInOutMode(int iPageInOutMode); /* 设置PageIn PageOut 模式*/
...
private:
	...
	int				iRunMode;				/* 运行模式　０：正常	１：回退　*/
	int				iPageInOutMode;	/* PAGEIN PAGE 模式　0:不要		１：要(默认)*/
