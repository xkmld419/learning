...
TBL_OTHER_EVENT_CLASS::TBL_OTHER_EVENT_CLASS()
{
		m_qry=NULL;
		sConditionSql="";
		sTableName="OTHER_EVENT";
		iCurPos=0;
		a_item=NULL;
...
void	TBL_OTHER_EVENT_CLASS::AddCondition(string sql)
{
		this->sConditionSql=sql;
}

void	TBL_OTHER_EVENT_CLASS::SetTableName(string sTableName)
{
		this->sTableName=sTableName;
}

void	TBL_OTHER_EVENT_CLASS::Open()
{
		string strSql;
		...
		try{
			...
			cout<<"Error occured ... in TBL_OTHER_EVENT_CLASS.cpp"<<endl;
...
bool	TBL_OTHER_EVENT_CLASS::Next()
{
		if ( m_qry == NULL)
...
long	TBL_OTHER_EVENT_CLASS::Get_EVENT_ID(void)
{
		return	item.EVENT_ID;
}

long	TBL_OTHER_EVENT_CLASS::Get_BILL_FLOW_ID(void)
{
		return	item.BILL_FLOW_ID;
}

long	TBL_OTHER_EVENT_CLASS::Get_BILLING_ORG_ID(void)
{
		return	item.BILLING_ORG_ID;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ORG_CALLING_NBR(void)
{
		return	item.ORG_CALLING_NBR;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ORG_CALLED_NBR(void)
{
		return	item.ORG_CALLED_NBR;
}

char*	TBL_OTHER_EVENT_CLASS::Get_THIRD_PARTY_AREA_CODE(void)
{
		return	item.THIRD_PARTY_AREA_CODE;
}

char*	TBL_OTHER_EVENT_CLASS::Get_START_DATE(void)
{
		return	item.START_DATE;
}

long	TBL_OTHER_EVENT_CLASS::Get_DURATION(void)
{
		return	item.DURATION;
}

long	TBL_OTHER_EVENT_CLASS::Get_SWITCH_ID(void)
{
		return	item.SWITCH_ID;
}

char*	TBL_OTHER_EVENT_CLASS::Get_TRUNK_IN(void)
{
		return	item.TRUNK_IN;
}

char*	TBL_OTHER_EVENT_CLASS::Get_TRUNK_OUT(void)
{
		return	item.TRUNK_OUT;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ACCOUNT_AREA_CODE(void)
{
		return	item.ACCOUNT_AREA_CODE;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ACCOUNT_NBR(void)
{
		return	item.ACCOUNT_NBR;
}

char*	TBL_OTHER_EVENT_CLASS::Get_NAS_IP(void)
{
		return	item.NAS_IP;
}

long	TBL_OTHER_EVENT_CLASS::Get_NAS_PORT_ID(void)
{
		return	item.NAS_PORT_ID;
}

long	TBL_OTHER_EVENT_CLASS::Get_RECV_BYTES(void)
{
		return	item.RECV_BYTES;
}

long	TBL_OTHER_EVENT_CLASS::Get_SEND_BYTES(void)
{
		return	item.SEND_BYTES;
}

long	TBL_OTHER_EVENT_CLASS::Get_RECV_PACKETS(void)
{
		return	item.RECV_PACKETS;
}

long	TBL_OTHER_EVENT_CLASS::Get_SEND_PACKETS(void)
{
		return	item.SEND_PACKETS;
}

long	TBL_OTHER_EVENT_CLASS::Get_FILE_ID(void)
{
		return	item.FILE_ID;
}

char*	TBL_OTHER_EVENT_CLASS::Get_CREATED_DATE(void)
{
		return	item.CREATED_DATE;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EVENT_STATE(void)
{
		return	item.EVENT_STATE;
}

char*	TBL_OTHER_EVENT_CLASS::Get_STATE_DATE(void)
{
		return	item.STATE_DATE;
}

long	TBL_OTHER_EVENT_CLASS::Get_ERROR_ID(void)
{
		return	item.ERROR_ID;
}

long	TBL_OTHER_EVENT_CLASS::Get_SERV_ID(void)
{
		return	item.SERV_ID;
}

long	TBL_OTHER_EVENT_CLASS::Get_SERV_PRODUCT_ID(void)
{
		return	item.SERV_PRODUCT_ID;
}

char*	TBL_OTHER_EVENT_CLASS::Get_CYCLE_BEGIN_DATE(void)
{
		return	item.CYCLE_BEGIN_DATE;
}

char*	TBL_OTHER_EVENT_CLASS::Get_CYCLE_END_DATE(void)
{
		return	item.CYCLE_END_DATE;
}

long	TBL_OTHER_EVENT_CLASS::Get_SERV_PROD_ATTR_USED_NUM(void)
{
		return	item.SERV_PROD_ATTR_USED_NUM;
}

long	TBL_OTHER_EVENT_CLASS::Get_ATTR_ID1(void)
{
		return	item.ATTR_ID1;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_VALUE1(void)
{
		return	item.ATTR_VALUE1;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_EFF_DATE1(void)
{
		return	item.ATTR_EFF_DATE1;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_EXP_DATE1(void)
{
		return	item.ATTR_EXP_DATE1;
}

long	TBL_OTHER_EVENT_CLASS::Get_ATTR_ID2(void)
{
		return	item.ATTR_ID2;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_VALUE2(void)
{
		return	item.ATTR_VALUE2;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_EFF_DATE2(void)
{
		return	item.ATTR_EFF_DATE2;
}

char*	TBL_OTHER_EVENT_CLASS::Get_ATTR_EXP_DATE2(void)
{
		return	item.ATTR_EXP_DATE2;
}

long	TBL_OTHER_EVENT_CLASS::Get_ORG_CHARGE1(void)
{
		return	item.ORG_CHARGE1;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_USED_NUM(void)
{
		return	item.EXTEND_USED_NUM;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID1(void)
{
		return	item.EXTEND_FIELD_ID1;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE1(void)
{
		return	item.EXTEND_VALUE1;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID2(void)
{
		return	item.EXTEND_FIELD_ID2;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE2(void)
{
		return	item.EXTEND_VALUE2;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID3(void)
{
		return	item.EXTEND_FIELD_ID3;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE3(void)
{
		return	item.EXTEND_VALUE3;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID4(void)
{
		return	item.EXTEND_FIELD_ID4;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE4(void)
{
		return	item.EXTEND_VALUE4;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID5(void)
{
		return	item.EXTEND_FIELD_ID5;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE5(void)
{
		return	item.EXTEND_VALUE5;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID6(void)
{
		return	item.EXTEND_FIELD_ID6;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE6(void)
{
		return	item.EXTEND_VALUE6;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID7(void)
{
		return	item.EXTEND_FIELD_ID7;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE7(void)
{
		return	item.EXTEND_VALUE7;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID8(void)
{
		return	item.EXTEND_FIELD_ID8;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE8(void)
{
		return	item.EXTEND_VALUE8;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID9(void)
{
		return	item.EXTEND_FIELD_ID9;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE9(void)
{
		return	item.EXTEND_VALUE9;
}

long	TBL_OTHER_EVENT_CLASS::Get_EXTEND_FIELD_ID10(void)
{
		return	item.EXTEND_FIELD_ID10;
}

char*	TBL_OTHER_EVENT_CLASS::Get_EXTEND_VALUE10(void)
{
		return	item.EXTEND_VALUE10;
}

void	TBL_OTHER_EVENT_CLASS::Set_EVENT_ID(long	lParam)
{
		item.EVENT_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_BILL_FLOW_ID(long	lParam)
{
		item.BILL_FLOW_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_BILLING_ORG_ID(long	lParam)
{
		item.BILLING_ORG_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_ORG_CALLING_NBR(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ORG_CALLED_NBR(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_THIRD_PARTY_AREA_CODE(char	* sParam)
{
		if ( strlen(sParam)>10 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_START_DATE(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_DURATION(long	lParam)
{
		item.DURATION=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_SWITCH_ID(long	lParam)
{
		item.SWITCH_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_TRUNK_IN(char	* sParam)
{
		if ( strlen(sParam)>12 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_TRUNK_OUT(char	* sParam)
{
		if ( strlen(sParam)>12 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ACCOUNT_AREA_CODE(char	* sParam)
{
		if ( strlen(sParam)>10 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ACCOUNT_NBR(char	* sParam)
{
		if ( strlen(sParam)>30 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_NAS_IP(char	* sParam)
{
		if ( strlen(sParam)>20 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_NAS_PORT_ID(long	lParam)
{
		item.NAS_PORT_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_RECV_BYTES(long	lParam)
{
		item.RECV_BYTES=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_SEND_BYTES(long	lParam)
{
		item.SEND_BYTES=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_RECV_PACKETS(long	lParam)
{
		item.RECV_PACKETS=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_SEND_PACKETS(long	lParam)
{
		item.SEND_PACKETS=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_FILE_ID(long	lParam)
{
		item.FILE_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_CREATED_DATE(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EVENT_STATE(char	* sParam)
{
		if ( strlen(sParam)>3 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_STATE_DATE(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ERROR_ID(long	lParam)
{
		item.ERROR_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_SERV_ID(long	lParam)
{
		item.SERV_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_SERV_PRODUCT_ID(long	lParam)
{
		item.SERV_PRODUCT_ID=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_CYCLE_BEGIN_DATE(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_CYCLE_END_DATE(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_SERV_PROD_ATTR_USED_NUM(long	lParam)
{
		item.SERV_PROD_ATTR_USED_NUM=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_ATTR_ID1(long	lParam)
{
		item.ATTR_ID1=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_ATTR_VALUE1(char	* sParam)
{
		if ( strlen(sParam)>30 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ATTR_EFF_DATE1(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ATTR_EXP_DATE1(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ATTR_ID2(long	lParam)
{
		item.ATTR_ID2=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_ATTR_VALUE2(char	* sParam)
{
		if ( strlen(sParam)>30 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ATTR_EFF_DATE2(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ATTR_EXP_DATE2(char	* sParam)
{
		if ( strlen(sParam)>14 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_ORG_CHARGE1(long	lParam)
{
		item.ORG_CHARGE1=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_USED_NUM(long	lParam)
{
		item.EXTEND_USED_NUM=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID1(long	lParam)
{
		item.EXTEND_FIELD_ID1=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE1(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID2(long	lParam)
{
		item.EXTEND_FIELD_ID2=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE2(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID3(long	lParam)
{
		item.EXTEND_FIELD_ID3=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE3(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID4(long	lParam)
{
		item.EXTEND_FIELD_ID4=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE4(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID5(long	lParam)
{
		item.EXTEND_FIELD_ID5=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE5(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID6(long	lParam)
{
		item.EXTEND_FIELD_ID6=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE6(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID7(long	lParam)
{
		item.EXTEND_FIELD_ID7=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE7(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID8(long	lParam)
{
		item.EXTEND_FIELD_ID8=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE8(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID9(long	lParam)
{
		item.EXTEND_FIELD_ID9=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE9(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_FIELD_ID10(long	lParam)
{
		item.EXTEND_FIELD_ID10=lParam;
}

void	TBL_OTHER_EVENT_CLASS::Set_EXTEND_VALUE10(char	* sParam)
{
		if ( strlen(sParam)>32 ) 
...
void	TBL_OTHER_EVENT_CLASS::AddItem(void)
{
		if (a_item==NULL)
			SetBuf();
		a_item[iCurPos++]=item;
...
void	TBL_OTHER_EVENT_CLASS::ClearBuf(void)
{
		item.ClearBuf();
		iCurPos=0;
		if (a_item==NULL)
...
void	TBL_OTHER_EVENT_CLASS::SetBuf(int iBufLen)
{
		iBufferSize=iBufLen;
		a_item=new _TBL_OTHER_EVENT_STR_[iBufferSize];
		ClearBuf();
}

void	TBL_OTHER_EVENT_CLASS::FreeBuf(void)
{
		if (a_item!=NULL){
			delete []a_item;
			a_item=NULL;
...
void	TBL_OTHER_EVENT_CLASS::SaveFlush(void)
{
...
vector<_TBL_OTHER_EVENT_STR_>	MEM_OTHER_EVENT_CLASS::a_item;
hash_map<const long ,_TBL_OTHER_EVENT_STR_* , hash<long>, MEM_OTHER_EVENT_CLASS::eqlong>	MEM_OTHER_EVENT_CLASS::hashmap;
MEM_OTHER_EVENT_CLASS::MEM_OTHER_EVENT_CLASS(char *sTableName)
{
		if (sTableName==NULL)
			Load();
		else
...
MEM_OTHER_EVENT_CLASS::~MEM_OTHER_EVENT_CLASS()
{
		/*UnLoad();*/
}

void	MEM_OTHER_EVENT_CLASS::Load(char *sTableName)
{
		if (a_item.size()>0)	return ;
		TBL_OTHER_EVENT_CLASS	 tempread;
		int		i;
		if (sTableName!=NULL)
...
void	MEM_OTHER_EVENT_CLASS::UnLoad(void)
{
		a_item.clear();
		hashmap.clear();
}

_TBL_OTHER_EVENT_STR_ *	MEM_OTHER_EVENT_CLASS::operator [](long opt)
{
		return hashmap[opt];
}
