...
{
    Control *Ctl11,*Ctl7,*Ctl9,*Ctl1,*Ctl2,*Ctl3,*Ctl4,*Ctl5,*Ctl6,*Ctl12,*Ctl13,*Ctl14,*Ctl15;
    RECT rt; TFILE *pHead;
    ...
    strcpy( Ctl11 ->sData , "流程号  进程 程序名                时间          状态 内存(M) cpu(%)" );
    strcpy( Ctl7  ->sData , "当前位置: HSS监控>> 进程管理>>" );
    strcpy( Ctl1  ->sData , "1.刷新" );
    strcpy( Ctl2  ->sData , "2.实时刷新" );
    strcpy( Ctl3  ->sData , "3.进程启动" );
    strcpy( Ctl4  ->sData , "4.进程kill" );
    ...
    Ctl13 ->pKeyPress = (KEYPRESS)&processCtl13Press;
    ...
    Ctl13 ->pHotKeyPress = (KEYPRESS)&process_SysHotKeyPress;
    ...
    CtlSetDir(Ctl13   ,    Ctl1,    Ctl6,    NULL,    Ctl15,   Ctl15,   Ctl14);
    CtlSetDir(Ctl14   ,    NULL,    NULL,    NULL,    NULL,    NULL,   Ctl15);
    CtlSetDir(Ctl15   ,    Ctl1,    Ctl6,    Ctl13,    NULL,    Ctl6,    NULL);
