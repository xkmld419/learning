...
extern int ConnectTT(ABMException &oExp, TimesTenConn &conn, const char *sTns);
extern int ConnectTT(ABMException &oExp, TimesTenConn &conn, const int iNodeID);

extern void CheckTTErrStatus(ABMException &oExp, TTStatus &st, int iLevel = 0);
