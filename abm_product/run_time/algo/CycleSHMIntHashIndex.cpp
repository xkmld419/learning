...
CycleSHMIntHashIndex::CycleSHMIntHashIndex(char *shmname) :
...
CycleSHMIntHashIndex::CycleSHMIntHashIndex(long shmkey) :
...
void CycleSHMIntHashIndex::create(unsigned int itemnumber) 
{
	//##计算HASHVALUE
