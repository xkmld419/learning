...
#define NO_PASSINFO 1024
#define MNT_REQ_PASSINFO  1022  //MNTGkGsPASSPEO"
#define REQ_PASSINFO_FILLED 1023 //RETURN PASSINFO
...
public:
    ...
    void setMqId(int id) {m_iMqId = id;} 
...
class TAppReqInfo{
 public:
    ...
    int       m_iProcessID; // m_wf_process.PROCESS_ID
