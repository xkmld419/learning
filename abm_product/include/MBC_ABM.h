#ifndef __MBC_ABM_H__
#define __MBC_ABM_H__
//#
//# 基本编码规则 2位目录编号+3位模块编号+4位信息编号
//#AVP编码规则为 2位目录编号+7位信息编号

#define	MBC_ABM_SUCC 0
...
#define MBC_DECODE_FAILED                                                       17
//@@	17	decode failed		please check code format
...
#define MBC_FILE_NAMEFORMAT_INVALID                                     110
//@@	110	file name invalid	please check the file name
#define MBC_FILE_DATAFORMAT_INVALID                                     111
//@@	111	file name invalid	please check the file data
...
#define MBC_STATIC_DATE_NOT_CONST_ERROR							379
//@@	379	关键局数据生效时间大于失效时间	     检查关键局数据生失效时间		

#define MBC_BORDER_ROAM_PROVINCE_MUL				386
//@@	386	边漫话单归属多个省	                               检查边漫话单，边漫归属配置

#define  MBC_ABM_AUTH_LOG                      1001
//@@	1001	鉴权日志	                               鉴权日志
...
#define MBC_ABM_UPDATE_NOT_EXIST					12000
//@@	12000	更新记录不存在        	                         检查更新的记录是否存在
#define MBC_ABM_LAST_CONTINUE_NOT_EXIT			12001
//@@	12001	找不到上一个连续消息包	                         检查传递消息包的连续性
#define MBC_ABM_AUTH_PAYPWD_FAIL					12002
//@@	12002	支付密码鉴权失败      	                         检查支付密码鉴权
#define MBC_ABM_CUSTID_ERROR						12003
//@@	12003	大客户标识不符合要求  	                         检查大客户标识是否符合规范
#define MBC_ABM_PRODUCTID_ERROR					12004
//@@	12004	产品编码不符合要求    	                         检查产品编码是否符合规范



#define MBC_ABM_SERV_CUST_ERROR					12100
//@@	12100	有用户资料没有客户资料	                         检查用户的客户资料是否存在
#define MBC_ABM_SERV_ACCT_ERROR					12101
//@@	12101	有用户资料没有帐户资料	                         检查用户的帐户资料是否存在
#define MBC_ABM_ACCT_CUST_ERROR					12102
//@@	12102	有帐户资料没有客户资料	                         检查帐户的客户资料是否存在
#define MBC_ABM_REFCUST_NOT_EXIT					12103
//@@	12103	依赖的大客户不存在    	                         检查依赖的大客户资料是否存在
#define MBC_ABM_REFSERV_NOT_EXIT					12104
//@@	12104	依赖的用户信息不存在  	                         检查依赖的用户信息是否存在
#define MBC_ABM_REFACCT_NOT_EXIT					12105
//@@	12105	依赖的账户信息不存在  	                         检查依赖的账户信息是否存在
#define MBC_ABM_BANK_NOT_EXIST					12106
//@@	12106	银行托收无银行帐号    	                         检查银行托收的银行帐号
#define MBC_ABM_SERV_MAX_ERROR					12107
//@@	12107	超过最大用户数	                                 检查用户数是否超过设定的最大用户数


#define MBC_ABM_OFFERINS_DATE_NOT_CONST_ERROR		12200
//@@	12200	销售品实例与销售品包含对象实例生失效时间不一致	 检查销售品实例与销售品包含对象实例的生失效时间是否一致
#define MBC_ABM_OFFER_EXP_MIN_EFF_ERROR			12201
//@@	12201	销售品失效日期小于生效日期                    	 检查销售品配置的失效日期是否小于生效日期
#define MBC_ABM_OFFER_MEMBER_NUM_ERROR			12202
//@@	12202	销售品包含对象成员数量异常（产品缺失或多）    	 检查销售品包含对象成员数量
#define MBC_ABM_OFFER_MEMBER_TYPE_ERROR			12203
//@@	12203	销售品包含对象成员类型异常                    	 检查销售品包含对象成员类型
#define MBC_ABM_OFFERINS_ATTR_LOST_ERROR			12204
//@@	12204	缺少必填的销售品属性实例                      	 检查是否缺少必填的销售品属性实例
#define MBC_ABM_OFFERINS_PARAM_LOST_ERROR			12205
//@@	12205	缺少必填的销售品参数实例                      	 检查是否缺少必填的销售品参数实例
#define MBC_ABM_OFFERINS_NUM_MAX_ERROR			12206
//@@	12206	超过最大销售品实例数                          	 检查销售品实例数是否超过设定的最大销售品实例数

#define MBC_ABM_OFFERINS_OFFER_NOT_CONST_ERROR		12207
//@@	12207	销售品实例与销售品不一致	 检查销售品实例中的销售品标识在销售品表中是否存在

#define MBC_ABM_OFFERINSANDPARAM_DATE_NOT_CONST_ERROR		12208
//@@	12208	销售品实例与销售品参数实例生失效时间不一致	 销售品实例与销售品参数实例生失效时间不一致

#define MBC_ABM_OFFERPARAM_EFFDATE_INVALID	12209
//@@	12209	销售品体系生效时间与规则不符合		请检查销售品生效时间及其规则
#define MBC_ABM_OFFERADD_EXPDATE_INVALID	12210
//@@	12210	新装销售品失效时间与规则不符合		请检查销售品失效时间及其规则
#define MBC_ABM_OFFERMODIFY_EXPDATE_INVALID	12211
//@@	12211	改装销售品失效时间与规则不符合		请检查销售品失效时间及其规则


#define MBC_INFO_PRODOFFER_NOT_EXIST		12112
//@@	12112	销售品不存在	 检查销售品表


#define MBC_PRODOFFER_PARAM_NOT_EXIST   12113
//@@	12113	销售品参数在参数表中不存在	          检查销售品表跟销售品参数表对应配置

#define MBC_PRODOFFER_PARAM_ENUM_FAIL   12214
//@@	12214	销售品参数枚举鉴权失败	          检查销售品参数表与参数枚举表对应配置

#define MBC_GROUP_MEMBER_VALID                  12115
//@@	12115	群组成员存在	          检查群组下是否有有效的成员

#define MBC_ABM_CUST_EXIST_ERROR		12108
//@@	12108	客户已经存在	 检查客户表，客户是否已经存在

#define MBC_ABM_ACCT_EXIST_ERROR		12109
//@@	12109	账户已经存在	 检查账户表，账户是否已经存在

#define MBC_ABM_SERV_EXIST_ERROR		12110
//@@	12110	用户已经存在	 检查用户表，用户是否已经存在


#define MBC_ABM_CUST_SAME_ERROR		12111
//@@	12111	过户客户相同	 检查过户订单，是否新老客户相同

#define MBC_ABM_GROUPMEMBER_NODATA_ERROR			12250
//@@	12250	电信网内群成员资料在主产品实例表无数据	         检查电信网内群成员资料是否在主产品实例表无数据


#define MBC_ABM_CUST_CREATE_MAX_ERROR			    12260
//@@	12260	开户失败	                                       检查用户资料完整性


#define MBC_ABM_OFFER_CATALOG_APPROVE_FAIL		12270
//@@	12270	销售品目录审批失败	                             检查销售品目录规范

#define MBC_ABM_OFFER_ONLINETIME_INVALID  12212
//@@	12212	在网时间与规则不符合	 检查在网时间配置规则

#define MBC_ABM_OFFER_BILLINGMODE_INVALID  12213
//@@	12213	销售品实例与计费模式规则不符	 检查销售品实例的计费规则

#define MBC_ABM_ORDER_REFUSED  12313
//@@	12313	消息拒收	 检查消息格式
...
#define  MBC_ACTION_LOG_CONVERT                100009
//@@	100009	启动CheciPoint	CheciPoint成功
#define  MBC_ACTION_DEBUG                      200000
//@@	200000	调试操作	      调整操作成功

#define MBC_ACTION_SCHEDULE_HIGH               100010
//@@	100010	触发高水位，启动进程	触发高水位，启动进程
#define MBC_ACTION_SCHEDULE_LOW                100011
//@@	100011	触发低水位，停止进程	触发低水位，停止进程

#define MBC_ABM_APP_SUCCESS               111110
//@@	111110	应用程序处理成功日志	应用程序处理成功日志
#define MBC_ABM_APP_FAIL                111111
//@@	111111	应用程序处理失败日志	应用程序处理失败日志

#define MBC_ABM_TIME_OUT               80001 
//@@	80001	time out	time out
#define MBC_ABM_EXCEPT               80002 
//@@	80002   except	except	
#define MBC_ABM_SEQ_ERR               80003 
//@@	80003	seq err     seq err	
#define MBC_ABM_OVER_TIMES               80004 
//@@	80004	over times  over times	
#define MBC_ABM_THROW               80005 
//@@	80005	throw    throw	
...
//@@	90200	调试操作	      调整操作成功
#define  MBC_ABM_AUTH_LOG                      90201  //ABM鉴权日志号
...
***/
#define MBC_ACTION_ABMEXPORT                   90012
//@@	90012	启动ABMexport	ABMexport成功
#define MBC_ACTION_ABMIMPORT                   90013
//@@	90013	启动ABMimport	ABMimport成功

#define MBC_SWITCH_SYSTEM        90300
//@@	90300	系统状态切换操作	      切换操作成功
#define MBC_DISPLAY_SYSTEM        90301
//@@	90301	显示ABMinit的处理过程操作	显示操作成功
...
//--------------------------------------------------------------------------
#define	MBC_ABM_UNKNOW_ERROR	-1
//@@	-1	未知错误	未知错误
#define	MBC_ABM_USER_NOT_EXIST	11001
//@@	11001	用户名不存在	用户名不存在
#define	MBC_ABM_USER_LOCKED	11002
//@@	11002	用户被锁定	用户被锁定
#define	MBC_ABM_PWD_FAIL	11003
//@@	11003	密码错误	密码错误
#define	MBC_ABM_IP_FAIL		11004
//@@	11004	IP不匹配	IP不匹配
#define	MBC_ABM_SERVICE_BUSY	11007
//@@	11007	系统繁忙，暂时不能提供服务	系统繁忙，暂时不能提供服务
#define	MBC_ABM_CONNECT_RE_CONNECT	11008
//@@	11008	对等端（用户）已经建立链接，又收到链接请求	对等端（用户）已经建立链接，又收到链接请求
#define	MBC_ABM_MSG_UNRECOGNIZED	11009
//@@	11009	消息包不可识别	消息包不可识别
#define	MBC_ABM_ABNORMAL_HEARTBEAT	11010
//@@	11010	心跳异常	心跳异常
#define	MBC_ABM_THREE_AUTHENTICATION_FAILED	11020
//@@	11020	连续3次鉴权失败	连续3次鉴权失败
#define	MBC_ABM_MSG_SIZE_OVERFLOW	11034
//@@	11034	单个包大小超过阀值	单个包大小超过阀值
#define	MBC_ABM_SIG_CHECK_FAIL	11101
//@@	11101	数字签名验证失败	数字签名验证失败
#define	MBC_ABM_ILLEGAL_KEYWORDS	11102
//@@	11102	含有非法关键字	含有非法关键字
#define	MBC_ABM_PROTOCOL_VERSION_FAIL	11103
//@@	11103	协议版本错误	协议版本错误
#define	MBC_ABM_MISS_FIELD	11104
//@@	11104	缺少必填字段	缺少必填字段
#define	MBC_ABM_VALUE_FIELD	11105
//@@	11105	字段值错误	字段值错误
#define	MBC_ABM_UNDEFINED_FIELD	11106
//@@	11106	未定义的标签或字段	未定义的标签或字段
#define	MBC_ABM_FORMAT_ERROR	11107
//@@	11107	格式转换错误	格式转换错误
#define	MBC_ABM_REPACKAGE_ERROR	11108
//@@	11108	检查收到的包是否重复	检查收到的包是否重复
#define	MBC_ABM_UNFOUND_SR	11201
//@@	11201	没有查到对应的SR	没有查到对应的SR
#define	MBC_ABM_BON_UNAVAILABLE	11202
//@@	11202	BON不可用(外部访问内部)	BON不可用(外部访问内部)
#define	MBC_ABM_BON_TIMEOUT	11203
//@@	11203	等待BON返回消息超时（如果需要返回应答）	等待BON返回消息超时（如果需要返回应答）
#define	MBC_ABM_EXTERNAL_UNAVAILABLE	11204
//@@	11204	外部网元不可用（内部访问外部）	外部网元不可用（内部访问外部）
#define	MBC_ABM_EXTERNAL_TIMEOUT	11205
//@@	11205	外部网元没有及时回复应答(外部网元超时)	外部网元没有及时回复应答(外部网元超时)
#define MBC_ABM_BON_RETURN_ERROR 11206
//@@	11206	BON 返回错误	BON 返回错误
#define	MBC_ABM_SCSP_INFO	11207
//@@	11207	scsp协议信息	scsp协议信息
#define	MBC_ABM_SERVICEPACKET_INFO	11208
//@@	11208	业务能力封装管理	业务能力封装管理
#define	MBC_ABM_TUXEDO_INFO	11209
//@@	11209	tuxedo协议信息	tuxedo协议信息
#define	MBC_ABM_SOAP_INFO	11210
//@@	11210	soap协议信息	soap协议信息
#define	MBC_ABM_DCC_INFO	11211
...
#define	MBC_ABM_READ_MEMERY_FAIL	11301
//@@	11301	读取共享内存数据异常	请检查共享内存数据
#define	MBC_ABM_AVP_TYPE_UNDEF	11302
//@@	11302	AVP数据类型未定义	请检查AVP数据类型定义
#define	MBC_ABM_MSG_MAP_TYPE_UNDEF	11303
//@@	11303	消息映射类型未定义	请检查消息映射类型型定义
#define	MBC_ABM_CONVERT_EXIT	11304
//@@	11304	消息转换进程退出	请参考系统日志
#define	MBC_ABM_MISS_AVP	11305
//@@	11305	未找到配置中的AVP值	请检查配置或消息源
#define	MBC_ABM_UNFOUND_SESSION_BUFF	11306
//@@	11306	未找会话的消息包	请消息是否返回
#define	MBC_ABM_UNDEF_GETVALUE_TYPE	11307
//@@	11307	未定义的取值类型	请取值类型配置
#define	MBC_ABM_CREATE_XML_FAIL	11308
//@@	11308	创建xml对象失败	请检查是否有足够内存
#define	MBC_ABM_CONVERT_FAIL	11309
//@@	11309	消息转换失败	请检查消息与配置
#define	MBC_ABM_UNDEF_DCC_CMD	11310
//@@	11310	未定义DCC命令码	请检查消息类型
#define	MBC_ABM_PARSE_MSG_FAIL	11311
//@@	11311	解析消息失败	请检查消息数据
#define	MBC_ABM_UNDEF_PROTO_TYPE	11312
//@@	11312	不支持的协议类型	请检查接入协议
#define	MBC_ABM_UNDEF_CONVERT_TYPE	11313
//@@	11313	不支持的消息类型转换	请检查消息映射配置
#define	MBC_ABM_MSG_MAP_FAIL	11314
//@@	11314	消息映射配置错误	请检查消息映射配置
#define MBC_ABM_EXT_NE_LINK_MISS	11315
//@@	11315	外部网元连接断开	请检查超时设置
#define	MBC_ABM_PARAM_DEAL_FAIL	11316
//@@	11316	ABM参数处理失败	ABM参数处理失败
#define	MBC_ABM_DISCARD_MESSAGE	11317
//@@	11317	丢弃消息	拥塞丢弃消息
#define	MBC_ABM_CONGESTION_INFO	11318
//@@	11318	拥塞信息	拥塞管理信息
#define	MBC_ABM_MESSAGE_INFO	11319
//@@	11319	消息处理信息	消息处理信息
#define	MBC_ABM_MESSAGE_OUT_TIME	11800
//@@	11800	消息超超时	消息超超时
#define	MBC_ABM_SR_ROUTE_FAIL	3002
//@@	3002	计费网路由异常	计费网路由异常

#define	MBC_ABM_SYSTEM_MAINTAIN	11500
//@@	11500	系统正常维护	系统正常维护
#define	MBC_ABM_MSG_PACKET_FAIL	11501
//@@	11501	消息包错误	请检查包结构
#define	MBC_ABM_SYSTEM_BUSY	11502
//@@	11502	系统超负载运行，需要释放链接	系统超负载运行，需要释放链接
#define	MBC_ABM_CLR_TIMEOUT	11503
//@@	11503	CLR超时	请检查链路或程序
#define	MBC_ABM_USRE_BALACKLIST	11504
//@@	11504	对端被纳入黑名单	对端被纳入黑名单
#define	MBC_ABM_USER_MSG_TOOBIG	11505
//@@	11505	在单位时间T内NE2向NE1发送的消息字节数总和已经超过系统允许的最大值	请降低发包频率
#define	MBC_ABM_USER_MSG_TIMES_TOOMORE	11506
//@@	11506	在单位时间T内NE2向NE1发送的能力调用请求次数已经超过系统允许的最大值	请降低发包频率
#define	MBC_ABM_USER_MISS_REQ	11507
//@@	11507	对端无响应	请检查链路或程序
#define	MBC_ABM_SCSP_PROTOCOL_VERSION_FAIL	11508
//@@	11508	协议版本号错误	协议版本号错误
#define	MBC_ABM_UNDOWN_FAIL	11599
//@@	11599	其它原因	未知异常
#define	MBC_ABM_DCC_FAIL	99999
//@@	99999	ABM校验DCC信息失败	ABM校验DCC信息失败


#define MBC_COMMAND_ABMPARAM           		11801
//@@	11801	执行ABMparam	      执行ABMparam
#define MBC_COMMAND_ABMPROCESS         		11802
//@@	11802	执行process	      执行process
#define MBC_COMMAND_ABMMONITOR         		11803
//@@	11803	执行ABMmonitor	      执行ABMmonitor
#endif
